...
#fig.show()
fig.write_html('./src/figures/feature_correlation_matrix.html')
...
#fig.show()
fig.write_html('./src/figures/feature_histograms.html')

# For target class
fig = px.histogram(df_cardiovascular, x='target')
#fig.show()
fig.write_html('./src/figures/label_histogram.html')
...
fig_knn.write_html('./src/figures/knn_scores.html')
...
fig_svm.write_html('./src/figures/svm_scores.html')
...
fig_dt.write_html('./src/figures/dt_scores.html')
...
fig_rf.write_html('./src/figures/rf_scores.html')
